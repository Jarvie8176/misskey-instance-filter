...
// @version      1.0.0
// @description  Filter Misskey timeline with partial match or wildcard search and alphabetical sorting.
// @author       JarvieK
// @license      MIT
// @match        *://*/*
// @include      *
...
(function () {
    ...
    function isPossibleMisskey() {
        return !!(document.querySelector('meta[content="Misskey"]') || document.getElementById('misskey_app') || window.mi);
    }
    ...
    function inject() {
        ...
        window.addEventListener('load', () => {
            if (!isPossibleMisskey() && !isDebug) return;
            GM_addStyle(`
